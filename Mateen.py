...
"""%s
 ...
 - author      : Abdul Mateen
 - facebook    : facebook.com/AbdulMateen
 - fanspage    : facebook.com/AbdulMateen
 - whatsap     : +923000000000
 - github      : github.com/Metoohacker
 - script name : Pros (king Facebook)
 - version     : 1.1
...
def banner():
	print (''' %s 
 © Group%s \n ________       _____.__  \n \____    /___ ____\__| %s> %sMetoo \n   /     /\\__  \  __\|  | %s> %sAkun \n  /     /_ / __ \|  |  | %s>%s Facebook [Meta] \n /_______   /__|  |__| %s>%s Indonesia \n         \/    \/ \n %s[%s*%s] By : %sAbdul Mateen \n %s[%s*%s] -------------------------------------- \n [%s*%s] IP : %s%s'''%
